...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/25 13:53:32 by escarrie          #+#    #+#             */
/*   Updated: 2021/03/19 14:12:32 by escarrie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		parse_file(t_minilibx *mlx, t_scene *data, t_figures **lst,
																char **strptr)
{
	char *str;
